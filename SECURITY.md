...
The latest release of DeskWarden is actively supported with security updates.
...
We aim to acknowledge vulnerability reports within **14 days** and will keep you updated on the progress of a fix.

## Disclosure Policy

Once a fix is available, we will publish a new release along with release notes describing the security fix. Credit will be given to the reporter unless anonymity is requested.
