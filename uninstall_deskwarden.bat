...
:: ============================================================
:step_check_install
:: Install folder এবং installed.flag চেক করে ইনস্টলেশন
:: অবস্থা নির্ধারণ করে। তিনটা scenario:
::   (A) Install folder আছে                → ইনস্টল করা আছে, এগিয়ে যাও
::   (B) Folder নেই, AppData আছে           → আগে আনইন্সটল হয়েছে, data বাকি
::   (C) Folder নেই, AppData নেই           → কিছুই নেই
:: ============================================================
...
:: Install folder নেই — আগে আনইন্সটল হয়েছে
echo.
echo  -----------------------------------------------------------
echo [91m  DeskWarden is already uninstalled.[0m

if exist "!APPDATA_DIR!" (
    :: AppData আছে — ইউজারকে option দাও
